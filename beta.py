...
seekaddr = '1KcvTNyYrSSStUb2UFqfMT6Ba7LVC4pS89' #Mainly seeks this address, script will run until it finds an exact match & will then stop.  Addresses matching vanity specified in variable "seq" will be printed onscreeen
